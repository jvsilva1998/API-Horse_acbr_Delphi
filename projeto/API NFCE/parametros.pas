...
type
 ...
 moodoFrete = class
  ...
  Formaspagamento = class   // PAGAMENTOS //
    ...
    troco:Double;
    tipoPagamento:Int64; // 1 - á vista 2- prazo 3- nenhum//
  end;
  ...
  {INFORMAÇÕES DO PRODUTO}
   ...
   {DUPLICATAS}
    ...
    {informações da nota}
    infoNota = class
      tipoAmbiente:Int64; // 1- produção -2 homologação//
  ...
  // info            : infoNota;
  // natureza        : natureza;
   infProduto      : tarray <infProdutoRecibo>;
