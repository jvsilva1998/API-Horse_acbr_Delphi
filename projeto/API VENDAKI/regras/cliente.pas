 ...
 function cadastra_cliente(dados:parametros.clientes;cod_usuario:string): TJSONObject;
  ...
  begin
     ...
     try
         ...
         if dados.codigoPais <> 1058 then
            begin
              if dados.cpfCnpj <> '' then
                 begin
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
           ...
           query.SQL.Add(',''' +funcoes.somenteNumeros(dados.codigoCidade)+'''');
  ...
  begin
     ...
     query.Connection   := conexao;
        ...
        try
           ...
           query.SQL.Add(',cod_cidade= ''' +funcoes.somenteNumeros(dados.codigoCidade)+ '''');
       ...
       begin
        ...
        try
               ...
               query.SQL.Add(' SELECT '+
                             ...
                             ',codigo_pais'+
                             ',cod_cliente'+
                             ' FROM CLIENTES where cpf_cnpj like ''%'+cnpj+'%'' AND nome_razao like ''%'+nome+'%'' '+codigoif+'  AND cod_usuario='''+cod_usuario+''' ORDER BY nome_razao ASC LIMIT '+IntToStr(registro)+' OFFSET '+IntToStr((pagina-1) * registro)+'  ');
               query.Open;
