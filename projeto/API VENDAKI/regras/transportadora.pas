  ...
  begin
     ...
     with query.Params do
        ...
        try
         ...
         query.SQL.Add(',''' +somenteNumeros(dados.ie)+ '''');
         query.SQL.Add(',''' +somenteNumeros(dados.im)+ '''');
         query.SQL.Add(',:RUA');
  ...
  begin
     ...
     query.Connection := conexao;
        ...
        try
           ...
           query.SQL.Add(',ie= ''' +somenteNumeros(dados.ie)+ '''');
           query.SQL.Add(',im= ''' +somenteNumeros(dados.im)+ '''');
