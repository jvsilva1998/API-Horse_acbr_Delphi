...
uses
 ...
 function atualizaNfce(cod_usuario:string;serie,numero,ambiente,largura:int64;csc:string;Idcsc:string;observacoes:string):TJSONObject;
                   ...
                   begin
                      ...
                      if query.FieldByName('bloqueado').AsString <> 'N' then  {VERIFICA SE O USUARIO ESTÁ BLOQUEADO}
                       ...
                       jsonRetorno  :=
                                    ...
                                    '      "larguraImpressao": '+query.FieldByName('nfcelargura').AsString+','+
  ...
  begin
     ...
     query.Connection := conexao;
        ...
        try
         ...
         query.SQL.Add(',nfcelargura='''+IntToStr(largura)+'''');
         query.SQL.Add(' WHERE codigousuario = '''+cod_usuario+'''');
         query.ExecSQL;
  ...
  begin
     ...
     query.Connection := conexao;
        ...
        try
           ...
           query.Close;
           query.SQL.Add
           ('SELECT 7- COUNT(*) AS TOTAL FROM vendas_credito  WHERE data_venda = CURDATE() AND cod_usuario = '''+cod_usuario+''' UNION ALL '+
            'SELECT 7- COUNT(*) AS TOTAL FROM vendas_usuarios WHERE data_venda = CURDATE() AND cod_usuario = '''+cod_usuario+'''   ;');
  ...
  begin
     ...
     query.Connection := conexao;
        ...
        try
           ...
           query.Close;
           query.SQL.Add('SELECT senhausuario from usuarios where emailusuario = '''+email+'''');
           query.Open;

           if query.RowsAffected = 1 then
              begin
                      codigoHttp     := 200;
                      tituloMensagem := 'senha encontrada';
                      mensagem       := funcoes.descript(query.FieldByName('senhausuario').AsString);
               ...
               begin
                     codigoHttp     := 404;
                     tituloMensagem := 'nenhuma senha encontrada';
                     mensagem       := 'verifique o email informado';
