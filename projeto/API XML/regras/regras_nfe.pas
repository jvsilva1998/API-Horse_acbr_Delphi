    ...
    query.Connection     := conexao;
                   ...
                   try
                       ...
                       while not(query.Eof) do
                        ...
                        TZipFile.ZipDirectoryContents('C:\xampp\htdocs\xml\'+codigo+'.zip', ExtractFilePath(Application.ExeName)+'\'+codigo);

                        RecursiveDelete('./'+codigo);
                        query.SQL.Clear;
  ...
  begin
     ...
     query.Connection := conexao;
        ...
        try
         ...
         query.ExecSQL;
         DeleteFile(PChar('C:\xampp\htdocs\xml\'+codigo+'.zip'));
                  ...
                  {desvincular perfil dos produtos}
                   ...
                   codigoHttp     := 200;
                     ...
                     begin
                       ...
                       mensagem       := 'o xml não foi encontrado';
                       codigoHttp     := 404;
                     end;
           except
            on E: Exception do
